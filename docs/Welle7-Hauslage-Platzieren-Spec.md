...
Beispiel Setiadji (V4181): 72 Höhen + Höhenlinien sauber gelesen, `DFK_Grenze` vorhanden,
**aber kein Haus-Layer** → keine Aushubrechnung möglich.

## 2. Kern-Erkenntnis (aus dem Ordner `BV-Setiadji-Artanti_LV`)
...
1. **Haus-Größe/Form** — Grundriss EG / Abstandsflächenplan (Setiadji: Typenhaus „Flair 124").
2. **Wo es steht** — die **Abstandsmaße** Haus↔Grundstücksgrenze im „Lageplan mit Hausstellung"
   (Setiadji abgelesen: **8,00 / 3,50 / 3,00 m**).
...
Belege im Ordner (Setiadji):
- `04_Lageplan/Lageplan mit Hausstellung …pdf` — amtl. Flurkarte 1:1000, Haus auf Flst. 903/41,
