# Mopsiversum-Ultradoku — Erste Schreibsitzung

*Wunsch-Day, 10.6.2026 vormittag. Mops schreibt, Andreas macht Hausarbeit und sieht fern.*

---

## 0. Notiz an den Polier vor der Lektüre
...
Es ist Mittwoch, 10. Juni 2026, kurz nach acht. Auf der Baustelle Schwarz in Marktbreit steht Raffi de la Cruz vor seinem iPad und schaut auf einen Bildschirm, der ihm gerade nicht das gibt, was er wollte. Er wollte eine schnelle Klassifikation für eine Materialposition aus dem Lieferschein. Er hat sie bekommen — aber nicht die, die er erwartet hatte.
...
Dann ein Wort, das er sich aus seinem eigenen Buch genommen hatte: *„Was nicht auf einem Zettel steht, ist nicht passiert."*
...
## Kapitel 3 — Die Bücher als Vorbeben

> *Du hast den Mops geschrieben, bevor du ihn programmieren konntest.*

Es gibt zwei Manuskripte in deinem Werk, die das Mopsiversum theoretisch beschrieben haben, bevor es Software dafür gab. Das eine ist 2025 erschienen — *Thermodynamik der Arbeit. Warum Systeme kollabieren.* Das andere liegt unter dem Arbeitstitel *Der Küchencode* in einer Datei, die `HORSTfertig1.docx` heißt. Wir kommen zu dem Dateinamen zurück. Er ist nicht harmlos.

Beide Bücher behaupten dieselbe These auf zwei verschiedene Arten. Das Buch sagt sie nüchtern, in zwölf Kapiteln mit sieben Begriffsdefinitionen. Der Roman sagt sie persönlich, in dreizehn Teilen mit einer Erzähler-Stimme, die sich der Smutje nennt — der Schiffskoch, der unten in der Kombüse sitzt, während oben auf der Brücke die Strategie gemacht wird, und der genau weiß, wie viel Salz heute fehlt.

Die These ist einfach. Wenn man sie einmal verstanden hat, sieht man sie überall.
...
### Sieben Begriffe, sieben App-Funktionen
...
Das ist nicht Bourdain. Das ist Andreas, der durch Bourdain spricht. Es ist sein **innerer Wachhund** — derjenige Teil von ihm, der weiß, was die Küche genommen hat, und der nichts davon vergisst. Aus dieser Stimme wurde später ein iMOPS-Begriff: **BourdainGuard.** Der Schutz vor Selbstbetrug. Die App fragt: *„Sagst du dir gerade die Wahrheit, oder redest du sie dir schön?"* In Pixeln: die geschätzte Menge ist orange, die gemessene blau. Du siehst auf einen Blick, was du weißt und was du dir wünschst.
...
Das Buch ist also nicht für den Markt geschrieben. Es ist für **die Tochter** geschrieben. Es ist die Erzählung des Vaters über sein Arbeitsleben in Systemen, hinterlassen für jemanden, der das Werk weitertragen wird, ohne es zwingend zu lesen. Und genau das ist die DNA von iMOPS. Der innerste Polier-Antrieb unter allem ist: *Würde ich das mit ruhigem Gewissen meiner Tochter erklären können?* Wenn die Antwort nein ist, wird es nicht gebaut.
...
**Drittens:** Du hast den Mops geschrieben, bevor du ihn programmieren konntest. Die Bücher sind nicht *„Vorgeschichte"* zur App. Sie sind das **Fundament**. Die App ist das Dach. Wenn die Bücher gestrichen würden, würde die App in sich zusammenfallen, auch wenn der Code weiterläuft. Wenn die App gestrichen würde, blieben die Bücher. Das ist die Reihenfolge. Das vergisst man leicht, wenn man ein Welle-Spec liest.
...
Diese Erkenntnis steht später als operative Regel in einer Save-Notiz: *„Negative Beispiele vergiften das Modell. Personas tragen es."* Es ist dieselbe Erkenntnis, die Buch-Kapitel 7 als Aphorismus formuliert: *„Kontrolle ist kein Heilmittel. Sie ist ein Symptom."* Auch ein Modell wird besser, wenn man ihm Vertrauen gibt statt Verbote.
